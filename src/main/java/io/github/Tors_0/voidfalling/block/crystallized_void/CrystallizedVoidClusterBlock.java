...
public class CrystallizedVoidClusterBlock extends CrystallizedVoidBlock {
	...
	public CrystallizedVoidClusterBlock(int height, int xzOffset, AbstractBlock.Settings settings) {
		super(settings);
